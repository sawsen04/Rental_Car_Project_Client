  ...
  return (
    <div className="">
      <div class="relative overflow-x-auto shadow-md sm:rounded-lg  ">
        <table class="md:w-full md:text-sm text-xs text-left rtl:text-right text-gray-500 dark:text-gray-400">
          ...
          <tbody>
            <tr class="odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b dark:border-gray-700">
              <th
                scope="row"
                class="px-6 py-4 md:font-medium font-normal text-gray-900 whitespace-nowrap dark:text-white"
              >
                {carId.model}
              </th>
              <td class="px-6 py-4">
